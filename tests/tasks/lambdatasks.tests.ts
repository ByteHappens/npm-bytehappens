...
describe("Lambda Task Execution", () => {
  it("Should run", async () => {
    let sut: runtimes.tasks.ITask = new runtimes.tasks.LambdaTask(async () => true, "LambdaTask", GetTestLoggerFactory());
  ...
  it("Should return true", async () => {
    ...
    let sut: runtimes.tasks.ITask = new runtimes.tasks.LambdaTask(
